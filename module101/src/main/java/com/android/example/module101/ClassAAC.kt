...
class ClassAAC {
	...
	private 	val instance_var_1_2: io.reactivex.internal.util.LinkedArrayList = io.reactivex.internal.util.LinkedArrayList(14)
	...
	fun method0(
		...
		for (iAb in 0..0) {
			for (iAc in 0..5) {
				param0.request(3279939251257000638)
				...
				local_var_4_1.request(-472312984256022483)
	...
	fun method2(
		...
		local_var_2_4.requestMore(8348000339156107959)
	...
	fun method3(
		param0: io.reactivex.subscribers.TestSubscriber<kotlin.Any>,
		param1: io.reactivex.internal.util.OpenHashSet<kotlin.Any>
	) {
